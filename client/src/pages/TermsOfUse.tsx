    ...
    <SiteLayout>
      <article className="container max-w-4xl mx-auto py-12 md:py-16">
        ...
        <div className="prose max-w-none mt-10 font-body" style={{ color: "#2C2C2C" }}>
          ...
          <p>To the maximum extent permitted by law, Brightpath Digital Media, LLC and its owners, employees, contractors, and contributors will not be liable for indirect, incidental, special, consequential, exemplary, or punitive damages, or for loss arising from use of or reliance on the Site, a product, a link, or third-party content. Nothing in these Terms excludes liability that cannot lawfully be excluded.</p>
