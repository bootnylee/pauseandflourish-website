    ...
    return (
      <SiteLayout>
        <div className="container py-20 text-center">
          <h1 className="font-display text-3xl" style={{ color: "var(--pf-ink)" }}>Author Not Found</h1>
          <Link href="/about">
  ...
  return (
    <SiteLayout>
      <div className="container py-16 max-w-3xl mx-auto">
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 mb-8 text-xs" style={{ color: "var(--pf-muted)" }}>
          ...
          <span>/</span>
          <span style={{ color: "var(--pf-ink)" }}>{author.name}</span>
        </div>
        ...
        <div className="flex items-start gap-6 mb-8">
          ...
          <div
            ...
            style={{ backgroundColor: "var(--pf-primary)", color: "var(--pf-paper)", letterSpacing: "0.05em" }}
          ...
          <div>
            ...
            <h1
              ...
              style={{ fontSize: "clamp(1.8rem, 3vw, 2.4rem)", color: "var(--pf-ink)" }}
            >
              {author.name}
            </h1>
            <p className="font-body text-sm font-semibold" style={{ color: "var(--pf-primary)" }}>
              {author.role}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-5 mb-12">
          {author.bioLong.split("\n\n").map((para, i) => (
            <p key={i} className="font-body leading-relaxed" style={{ color: "var(--pf-ink)", fontSize: "1.05rem" }}>
              {para}
            </p>
          ))}
        </div>
