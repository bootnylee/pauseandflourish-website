  ...
  return (
    <SiteLayout>
      <article className="container max-w-3xl mx-auto py-12">
        <nav className="font-body text-sm mb-8" style={{ color: "var(--pf-soft-ink)" }} aria-label="Breadcrumb">
        ...
        <h1 className="font-display font-bold leading-tight mb-6" style={{ color: "var(--pf-primary-dark)", fontSize: "clamp(2rem, 4vw, 3rem)" }}>
          {article.headline}
        </h1>
        <p className="font-body text-lg leading-relaxed mb-8" style={{ color: "var(--pf-soft-ink)" }}>
          {article.takeaway}
        </p>
        <section className="border-t pt-6" style={{ borderColor: "var(--pf-tint)" }}>
          <p className="section-label mb-2">Citation</p>
          <p className="font-body leading-relaxed" style={{ color: "var(--pf-ink)" }}>{article.citation}</p>
          {article.url && (
            <a href={article.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-label text-sm font-semibold mt-5" style={{ color: "var(--pf-primary)" }}>
