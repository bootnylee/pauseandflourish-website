...
export const allProducts: Product[] = [
  // ── New Reviews: Week of 2026-09-07 ───────────────────────────────────────
  {
    ...
    name: "CHOSHOME Cooling Blanket for Hot Sleepers, Blue, 90 x 108 Inches",
    brand: "CHOSHOME",
    asin: "B0CNGFWV58",
    affiliateUrl: buildAffiliateUrl("B0CNGFWV58"),
    ...
    rating: 0,
    reviewCount: 0,
    heroImage: "https://m.media-amazon.com/images/I/81rIrRKSypL._AC_SL1500_.jpg",
    summary: "A lightweight, non-powered blanket with double-sided cooling fabric for shoppers seeking broad bed or couch coverage on warm nights.",
    pros: [
      "The Amazon listing identifies this as a 90 x 108 inch blanket for hot sleepers, hot flashes, and night sweats",
      "Double-sided cooling fabric provides a non-powered comfort option",
      "The listing describes it as lightweight, foldable, and machine washable",
      "Large size can cover a bed or couch rather than one small body area",
    ],
    cons: [
    ...
    ingredients: ["Cooling textile fibers", "Double-sided cooling fabric"],
    verdict: "CHOSHOME is a practical comfort-accessory choice for someone who wants a large, non-powered cooling layer available for bed or couch use. Its main strength is broad coverage; the trade-off is a bulkier format than localized cooling accessories.",
    score: 7.5,
    editorPick: false,
    bestFor: "Broad, non-powered cooling coverage for bed or couch use",
    tags: ["cooling blanket", "hot flashes", "night sweats", "hot sleepers", "non-powered cooling", "lightweight bedding"],
    shortDescription: "A lightweight, double-sided cooling blanket for warm nights, hot sleepers, and night-sweat comfort.",
    fullReview: "This large, non-powered blanket is a practical bedding option for people who want a lighter layer available during warm nights, hot flashes, or night sweats. The Amazon title specifically positions it for hot sleepers and names those use cases.\n\nIts main trade-off is size: 90 x 108 inches provides broad bed or couch coverage but is less compact than a towel or wearable. The listing also describes it as lightweight, foldable, and machine washable, which may suit home or travel use.\n\nCooling feel varies by person and room conditions, so treat it as a comfort accessory rather than a treatment. Check the selected size and care directions before buying, and stop using it if the fabric or temperature feels uncomfortable.",
    priceDisplay: "",
    publishDate: "2026-09-07",
    authorId: "diane-kessler",
    editorNote: "This is a broad-coverage comfort layer, not a treatment for hot flashes; the practical question is whether a king-size blanket fits the sleep setup.",
  },
  {
  ...
  },
  {
    ...
    pros: [
      ...
      "Price snapshot was $16.79 for 30 tablets at verification",
    ],
    cons: [
      "Relatively small Amazon review base at the verification date",
    ...
    verdict: "Nature's Bounty Advanced Menopause Relief is a practical option for shoppers who value a simple one-tablet botanical formula and understand that response to supplements can vary. Its focused ingredient list and accessible entry price are its strongest practical advantages, while the modest review base makes it less established than some long-running products in this category.",
    score: 7.6,
    editorPick: false,
    ...
    fullReview: "Nature's Bounty Optimal Solutions Advanced Menopause Relief is positioned as a focused, one-tablet daily supplement rather than an expansive multi-ingredient blend. The current Amazon listing identifies Siberian rhubarb extract and saffron extract as its featured ingredients, with a vegan formula and no added hormones.\n\nThe value proposition is mainly simplicity: a 30-tablet bottle, one daily tablet, and an accessible price snapshot of $16.79 at the time this review was verified. That can suit shoppers who prefer a compact routine and want to avoid a high pill burden.\n\nThe trade-off is that its Amazon review base was still comparatively small at the time of review. Individual response, medication interactions, and health history matter, so shoppers should review the label and ask a clinician or pharmacist about suitability rather than treating product marketing as a personal treatment plan.",
    priceDisplay: "$16.79",
...
At $80 for a 1.7 fl oz jar, Evening Wear is priced at the premium end of the menopause skincare market. The review base is smaller than mass-market retinol creams, but the ratings are consistent and the brand's overall product line has strong consumer engagement. For women who want a retinoid night cream that was specifically designed for menopause skin rather than adapted from a general anti-aging line, STRIPES Evening Wear is the strongest premium option in this catalog.`,
...

  {
    ...
    pros: ["Direct Amazon listing confirmed in stock with Add to Cart and Buy Now options", "Hormone-free formula specifically positioned for hot flashes and night sweats", "Two-month 120-tablet supply can reduce reorder frequency", "Made by a menopause-focused brand with a clear single-use-case positioning"],
    cons: ["Premium upfront price at $108.00 for the two-month supply", "Small current Amazon review base compared with established high-volume alternatives", "Proprietary blend does not disclose individual ingredient amounts on the listing"],
