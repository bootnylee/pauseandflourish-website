...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 892,
    heroImage: "https://m.media-amazon.com/images/I/41hZ2gq-wGL._SL500_.jpg",
  ...
  // ── Sleep & Mood Support ───────────────────────────────────────────────────
  {
    ...
    rating: 4.5,
    reviewCount: 28943,
    heroImage: "https://m.media-amazon.com/images/I/41nx5ZFPTxL._SL500_.jpg",
...
At $80 for a 1.7 fl oz jar, Evening Wear is priced at the premium end of the menopause skincare market. The review base is smaller than mass-market retinol creams, but the ratings are consistent and the brand's overall product line has strong consumer engagement. For women who want a retinoid night cream that was specifically designed for menopause skin rather than adapted from a general anti-aging line, STRIPES Evening Wear is the strongest premium option in this catalog.`,
  ...
  },
  {
    ...
    rating: 4.2,
    reviewCount: 312,
    summary: "Gynable UroCollagen is an Italian-made powder supplement combining collagen peptides, creatine, black cohosh, and magnesium to strengthen pelvic floor muscles and address urinary urgency and leakage during menopause.",
    verdict: "Gynable UroCollagen is a compelling multi-ingredient approach to pelvic floor health for menopausal women, combining structural support (collagen, creatine) with hormonal balance (black cohosh) and mineral support (magnesium). It is the best choice for women who want a comprehensive, drug-free intervention for bladder control that works from the inside out.",
    editorPick: false,
