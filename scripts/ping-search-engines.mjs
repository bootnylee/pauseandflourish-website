...
async function pingIndexNow() {
  ...
  const payload = {
    ...
    urlList: [
      ...
      `${SITE_URL}/quiz`,
      `${SITE_URL}/category/multi-symptom-supplements`,
      `${SITE_URL}/category/sleep-mood-support`,
      `${SITE_URL}/category/hot-flash-cooling`,
      `${SITE_URL}/category/bone-joint-health`,
      `${SITE_URL}/category/vaginal-intimate-health`,
      `${SITE_URL}/category/menopause-skincare`,
      `${SITE_URL}/category/fitness-pelvic-health`,
      `${SITE_URL}/category/cognitive-energy-support`,
    ],
  };
